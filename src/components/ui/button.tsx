...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:scale-105 hover:shadow-hover transition-all duration-300",
        destructive:
        ...
        hero: "bg-gradient-primary text-foreground hover:scale-105 hover:shadow-hover transition-all duration-300 border border-primary/20",
        gradient: "bg-gradient-hero text-primary-foreground hover:scale-105 hover:shadow-hover transition-all duration-300",
      },
      size: {
